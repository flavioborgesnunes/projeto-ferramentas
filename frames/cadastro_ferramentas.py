...
def botao_cadastroF(self):
    ...
    self.frame_cadastro = Frame(
        self.root, bd=4, bg=FONT_BG, highlightbackground='#aabbcc',
        highlightthickness=0)
    self.frame_cadastro.place(relx=0.23, rely=0.0, relwidth=0.77, relheight=1)

    self.title_cadastro = Label(self.frame_cadastro, fg="#16213E",
                                text="CADASTRO DE FERRAMENTAS",
                                background='#BBBFCA',
                                font=("Arial", 14, "bold"))
    self.title_cadastro.place(relx=0.25, rely=0.03)

    self.lb_descricao = Label(self.frame_cadastro, fg=FONT_COLOR,
    ...
    self.descricao_entry = Entry(
        self.frame_cadastro, highlightbackground='#878787',
        highlightthickness=1)
    self.descricao_entry.place(
        relx=0.05, rely=0.22, relwidth=0.60, relheight=0.04)
    self.lb_fabricante = Label(self.frame_cadastro, text='Fabricante',
                               fg=FONT_COLOR,  background=FONT_BG,
                               font=(FONT_TYPE, FONT_TAM, "bold"))
    ...
    self.lb_voltagem = Label(self.frame_cadastro, fg=FONT_COLOR,
                             text='Voltagem', background=FONT_BG,
                             font=(FONT_TYPE, FONT_TAM, "bold"))
    ...
    self.lb_tamanho = Label(self.frame_cadastro, text='Tamanho', fg=FONT_COLOR,
                            background=FONT_BG,
                            font=(FONT_TYPE, FONT_TAM, "bold"))
    ...
    self.lb_tamanho_x = Label(self.frame_cadastro, text='X', fg=FONT_COLOR,
                              background=FONT_BG,
                              font=(FONT_TYPE, FONT_TAM, "bold"))
    ...
    self.lb_material = Label(self.frame_cadastro,
                             text='Material da Ferramenta', fg=FONT_COLOR,
                             background=FONT_BG,
                             font=(FONT_TYPE, FONT_TAM, "bold"))
    ...
    self.material_entry.place(relx=0.05, rely=0.72,
                              relwidth=0.60, relheight=0.04)
    self.lb_tempo = Label(self.frame_cadastro, text='Tempode Reserva',
                          fg=FONT_COLOR,
                          background=FONT_BG,
                          font=(FONT_TYPE, FONT_TAM, "bold"))
    ...
    self.lb_critica = Label(self.frame_cadastro, fg=FONT_COLOR,
                            text='É Crítica?', background=FONT_BG,
                            font=(FONT_TYPE, FONT_TAM, "bold"))
    ...
    self.lb_quantidade = Label(self.frame_cadastro, text='Quantidade',
                               fg=FONT_COLOR,  background=FONT_BG,
                               font=(FONT_TYPE, FONT_TAM, "bold"))
    ...
    self.bt_cadastrarF = Button(
        ...
        command=lambda: self.cadastrar_ferramentas(self))
