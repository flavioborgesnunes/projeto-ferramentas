...
def cadastrar_login(self):
    ...
    with open('./arquivos/senha_entrada.csv', 'r') as file:
        ...
        if msg3:
            ...
            with open('./arquivos/senha_entrada.csv', 'a', newline='') as csvfile2:
...
def excluir_user(self):
    ...
    if MsgBox == 'yes':
        ...
        with open('./arquivos/senha_entrada.csv', 'w', newline='') as writeFile:
            writer = csv.writer(writeFile)
            writer.writerows(lines)
